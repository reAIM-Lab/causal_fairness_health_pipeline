...
# CHANGE FOR FEATURE SELECTION-BASED METHODS
with open(f'{int_path}/COLUMNS', "rb") as fp:   # Unpickling
    data_columns_dict = pickle.load(fp)
data_columns = data_columns_dict['X'] + data_columns_dict['Z'] + data_columns_dict['W']
