...
# set up dataset
"""
SET UP DATASET AND MODEL DIRECTORY
"""
...
with open(f'COLUMNS', "rb") as fp:   # Unpickling
    data_columns_dict = pickle.load(fp)
data_columns = data_columns_dict['Z'] + data_columns_dict['W']
...
for params in permutations_dicts:
    ...
    model_config['params'] = {'hidden_size': params['hidden_size'], 'dim_feedforward': params['dim_feedforward'],
                              ...
                              'n_features': num_reduced_features}
