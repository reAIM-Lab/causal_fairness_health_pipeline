...
# set up dataset
def main(disease, weight_y, prior_prob, x1, x0):
...
main('ami', 'calc', None, 'is_Male', 'is_Female')
main('sle', 0.01, 0.01, 'is_Male', 'is_Female')
main('t2dm', 'calc', None, 'is_Black', 'is_White')